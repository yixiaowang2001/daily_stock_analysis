...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "IBKR_FLEX_TOKEN": {
        "title": "IBKR Flex Web Service Token",
        "description": "Client Portal Flex Web Service token; used with Query ID to fetch Open Positions CSV (not TWS).",
        "category": "base",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "IBKR_FLEX_QUERY_ID": {
        "title": "IBKR Flex Query ID",
        "description": "Flex Query ID for a report that includes Open Positions and outputs CSV format.",
        "category": "base",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
