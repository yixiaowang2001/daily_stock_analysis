...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "IWENCAI_API_KEY": {
        ...
        "description": "API key for Tonghuashun Iwencai OpenAPI fallback. Used only as a low-priority data/search fallback.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "ENABLE_IWENCAI_FALLBACK": {
        "title": "Enable Iwencai Fallback",
        "description": "Use Iwencai only after normal realtime quote/search providers fail. Defaults to enabled when IWENCAI_API_KEY is configured.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "IWENCAI_DAILY_CALL_LIMIT": {
        "title": "Iwencai Daily Call Limit",
        "description": "Local daily guard for all Iwencai fallback calls. Keep at or below the upstream shared daily quota.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "IWENCAI_TIMEOUT_SECONDS": {
        "title": "Iwencai Timeout Seconds",
        "description": "HTTP timeout for Iwencai fallback requests.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "IWENCAI_BASE_URL": {
        ...
        "description": "Iwencai OpenAPI base URL.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "IWENCAI_USAGE_PATH": {
        "title": "Iwencai Usage Path",
        "description": "Local JSON file path used to count shared Iwencai fallback calls per day.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "./data/iwencai_usage.json",
        "options": [],
        "validation": {},
        "display_order": 21,
    },
    ...
    "US_MARKET_DATA_SOURCE_PRIORITY": {
        "title": "US Market Data Source Priority",
        "description": "Legacy comma-separated priority for US stock market providers, used when US_DAILY_DATA_SOURCE_PRIORITY and US_REALTIME_DATA_SOURCE_PRIORITY are empty.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "ibkr,longbridge,massive,twelvedata,finnhub,alpha_vantage,yfinance",
        "options": [],
        "validation": {},
        "display_order": 26,
    },
    "US_DAILY_DATA_SOURCE_PRIORITY": {
        "title": "US Daily Data Source Priority",
        "description": "Comma-separated priority for US daily/history providers: ibkr,longbridge,massive,twelvedata,finnhub,alpha_vantage,yfinance.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "US_REALTIME_DATA_SOURCE_PRIORITY": {
        "title": "US Realtime Data Source Priority",
        "description": "Comma-separated priority for US quote providers: ibkr,longbridge,twelvedata,finnhub,alpha_vantage,massive,yfinance.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "ibkr,longbridge,twelvedata,finnhub,alpha_vantage,massive,yfinance",
        "options": [],
        "validation": {},
        "display_order": 26,
    },
    "US_REALTIME_STOP_AFTER_BASIC_QUOTE": {
        "title": "US Realtime Stop After Basic Quote",
        "description": "When true, US realtime routing returns after the first provider with a basic price quote instead of calling later providers to supplement valuation fields, reducing API usage for live quote workflows.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "US_INTRADAY_DATA_SOURCE_PRIORITY": {
        "title": "US Intraday Data Source Priority",
        "description": "Comma-separated priority for US 1-minute historical bar providers used by agent backtest cutoff evidence: massive,twelvedata,ibkr.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "massive,twelvedata,ibkr",
        "options": [],
        "validation": {},
        "display_order": 26,
    },
    "US_INTRADAY_CACHE_DIR": {
        "title": "US Intraday Cache Dir",
        "description": "Local directory for cached US 1-minute historical bars, reducing repeated provider calls when replaying multiple cutoffs on the same trading day.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "data/us_intraday_cache",
        "options": [],
        "validation": {},
        "display_order": 26,
    },
    "US_INTRADAY_429_RETRY_SECONDS": {
        "title": "US Intraday 429 Retry Seconds",
        "description": "Base backoff seconds before retrying a US intraday provider after HTTP 429 rate limiting. Retries scale linearly by attempt.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "IBKR_HOST": {
        "title": "IBKR Host",
        "description": "Interactive Brokers Gateway/TWS API host for US market data. Defaults to localhost.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "IBKR_PORT": {
        "title": "IBKR Port",
        "description": "Interactive Brokers Gateway/TWS API port. IB Gateway live usually uses 4001 and paper usually uses 4002.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "IBKR_CLIENT_ID": {
        "title": "IBKR Client ID",
        "description": "Client id used by DSA market-data requests. Use a value that is not used by another IB API client.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "IBKR_TIMEOUT_SECONDS": {
        "title": "IBKR Timeout Seconds",
        "description": "Timeout for each IBKR Gateway market-data request.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "IBKR_FAILURE_COOLDOWN_SECONDS": {
        "title": "IBKR Failure Cooldown Seconds",
        "description": "Cooldown after an IBKR market-data timeout or no-response failure, so a US watch cycle can fail open to other providers instead of waiting once per symbol.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "IBKR_MARKET_DATA_TYPE": {
        "title": "IBKR Market Data Type",
        "description": "IBKR reqMarketDataType value for snapshots: 1 live, 2 frozen, 3 delayed, 4 delayed frozen.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "IBKR_INTRADAY_USE_RTH": {
        "title": "IBKR Intraday Use RTH",
        "description": "Whether IBKR historical 1-minute bars should be limited to regular trading hours. Default false keeps premarket/after-hours bars for US agent-backtest replay.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "ALPHA_VANTAGE_API_KEY": {
        ...
        "description": "Optional US stock data fallback key. Free tier is suitable for low-frequency daily/quote fallback and latest company overview fundamentals.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "FINNHUB_API_KEY": {
        ...
        "description": "Optional US stock data fallback key for quote, daily candles, company profile, and basic financial metrics.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "US_FUNDAMENTAL_STAGE_TIMEOUT_SECONDS": {
        "title": "US Fundamental Stage Timeout",
        "description": "Total timeout budget for US fundamental provider aggregation.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "US_FUNDAMENTAL_FETCH_TIMEOUT_SECONDS": {
        "title": "US Fundamental Fetch Timeout",
        "description": "Per-provider timeout for US fundamental profile/metric requests.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "TWELVEDATA_API_KEY": {
        ...
        "description": "Optional US stock data fallback key for quote and daily candles.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "MASSIVE_API_KEY": {
        ...
        "description": "Optional Massive/Polygon-compatible US aggregate and snapshot fallback key.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "POLYGON_API_KEY": {
        "title": "Polygon API Key",
        "description": "Optional fallback key used by the Massive-compatible US data fetcher when MASSIVE_API_KEY is empty.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "MASSIVE_BASE_URL": {
        "title": "Massive Base URL",
        "description": "Base URL for Massive/Polygon-compatible market data endpoints.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "https://api.massive.com",
        "options": [],
        "validation": {"item_type": "url", "allowed_schemes": ["https"]},
        "display_order": 32,
    },
