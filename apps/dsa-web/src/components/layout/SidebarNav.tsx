...
import { BarChart3, BriefcaseBusiness, Crosshair, Home, LogOut, MessageSquareQuote, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'tail-tactics', label: '战术台', to: '/tail-tactics', icon: Crosshair },
